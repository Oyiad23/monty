...
/**
 * monty_ssul - Rotates the top value of a stack_t linked list to the bottom.
...
/**
 * monty_stul - Rotates the bottom value of a stack_t linked list to the top.
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 */
void monty_stul(stack_t **stack, unsigned int line_number)
...
/**
 * monty_stackline - Converts a queue to a stack.
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 */
void monty_stackline(stack_t **stack, unsigned int line_number)
...
/**
 * monty_line - Converts a stack to a queue.
 * @stack: A pointer to the top mode node of a stack_t linked list.
 * @line_number: The current working line number of a Monty bytecodes file.
 */
void monty_line(stack_t **stack, unsigned int line_number)
